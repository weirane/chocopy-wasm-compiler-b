...
export type FunDef<A> = { a?: A, envRead?: Set<string>, envWrite?: Set<string>, name: string, parameters: Array<Parameter<A>>, ret: Type, inits: Array<VarInit<A>>, body: Array<Stmt<A>> }
